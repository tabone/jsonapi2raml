 ...
 * JSON-API Top-Level Documents that show a list of JSON-API Resources.
 * @type {Object}
 */
module.exports = Object.assign(Object.create(asset), {
  /**
   * RAML Type representing an instance of a JSON-API Top-Level Document showing
   * a list of JSON-API Resources.
   * @type {Object}
   */
  raml: null,
  ...
  init (info) {
    ...
    this.name = nameUtils.types.multipleResourceDocument(this.resource.type)
...
function setupRAML ({ resource, resourceType }) {
  ...
  this.raml = {
    type: 'object',
    displayName: `JSON-API '${resourceName} Multiple Resource Document'`,
    description: `JSON-API Document for when returing a multiple ` +
