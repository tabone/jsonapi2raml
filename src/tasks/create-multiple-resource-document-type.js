...
const { multipleResourceDocument } = require('../assets/models/types')

/**
 * Function used to create the RAML Type Representational object for the
 * JSON-API Top-Level Document showing a list of JSON-API Resources.
...
module.exports = info => {
  ...
  return Object.create(multipleResourceDocument).init(info)
}
